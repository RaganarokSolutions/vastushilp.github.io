      ...
      var S = function (e) {
            ...
            function (e) {
              if (de.current && me.current) {
                ...
                var r =
                  ...
                  i =
                    ((0, u.getPercentOffsetForSlide)(t, K, W, S, V) / 100) * o;
                if (V) {
                  var a = o / 3;
                  e < 0 && (i += a), e >= K && (i -= a);
                }
          ...
          we = function (e) {
            if (ne && me.current) {
              ...
              if (Pe.current.length > 1)
                for (
                  var n = Pe.current[0],
                    r = Pe.current[Pe.current.length - 1],
                    o = r.time - n.time,
              ...
              if (a < l) he(G);
                ...
                for (
                  ...
                  f =
                    ie > 0
                      ? (0, s.getNextMoveIndex)(I, V, f, K, q, W, S)
                      : (0, s.getPrevMoveIndex)(I, V, f, q, W, S);
                f !== G && R(e), he(f);
              }
            }
          },
              ...
              if (ne) {
                for (
                  var t = null === se.current,
                    ...
                    r = ie + n,
                    o = Date.now();
                  Pe.current.length > 0 && !(o - Pe.current[0].time <= 100);

                )
                  Pe.current.shift();
                Pe.current.push({ pos: r, time: o }),
                  t || ae(r),
                  (se.current = e);
              }
            },
        ...
        return o.default.createElement(
          ...
          o.default.createElement(a.default, {
            ...
            message: _({ currentSlide: G, count: K }),
          }),
          ...
          o.default.createElement(
            ...
            o.default.createElement(
              ...
              V ? Ie("prev-cloned") : null,
              Ie(),
              V ? Ie("next-cloned") : null
            )
          )
        );
      };
