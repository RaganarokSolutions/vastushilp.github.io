  ...
  [6120],
  {
    76489: function (e, t) {
      ...
      (t.parse = function (e, t) {
        ...
        for (
          var o = {}, i = t || {}, c = e.split(";"), a = i.decode || n, u = 0;
          u < c.length;
          u++
        ) {
          var l = c[u],
    ...
    47041: function (e, t, n) {
      ...
      t.setCookie = function (e, t, n) {
        ...
        var d = (0, r.serialize)(e, a(t), o({ path: "/" }, u));
        if (c()) document.cookie = d;
        else if (s && l) {
          var f = s.getHeader("Set-Cookie");
          if (
            (Array.isArray(f) || (f = f ? [String(f)] : []),
            s.setHeader("Set-Cookie", f.concat(d)),
            l && l.cookies)
          ) {
            var b = l.cookies;
    ...
    4803: function (e, t, n) {
      ...
      var o = n(80969),
        ...
        j = function (e) {
              ...
              j || (j = (0, l.getCookie)("pt")),
                j &&
                  ...
                  void 0 === e
                    ...
                    : e.pt) !== j &&
                  "public" !== a.status &&
                  O.replace("".concat(O.asPath, "?pt=").concat(j), void 0, {
                    shallow: !0,
                  });
            },
            [O, j, a]
          ...
          return n && "parent" !== n.type
            ? null === (t = n.blocks) || void 0 === t
              ? void 0
              : t.map(function (e, t) {
                  return (function (e, t) {
                    var n;
                    switch (
                      ...
                      case "banner":
                        var o;
                        return (0,
                        i.jsx)(b, { id: "banner-".concat(t), block: e, website: a }, "website-block-".concat(null === (o = e.WebsiteBlock) || void 0 === o ? void 0 : o._id, "-").concat(t));
                      case "contact":
                        var r;
                        return (0,
                        i.jsx)(g, { id: "contact-".concat(t), block: e, website: a, captchaKey: d, apiUrl: u }, "website-block-".concat(null === (r = e.WebsiteBlock) || void 0 === r ? void 0 : r._id, "-").concat(t));
                      case "gallery":
                        var c;
                        return (0,
                        i.jsx)(k, { id: "gallery-".concat(t), block: e, website: a }, "website-block-".concat(null === (c = e.WebsiteBlock) || void 0 === c ? void 0 : c._id, "-").concat(t));
                      case "hero":
                        var l;
                        return (0,
                        i.jsx)(p, { id: "hero-".concat(t), block: e, website: a }, "website-block-".concat(null === (l = e.WebsiteBlock) || void 0 === l ? void 0 : l._id, "-").concat(t));
                      case "list":
                        var s;
                        return (0,
                        i.jsx)(h, { id: "list-".concat(t), block: e, website: a }, "website-block-".concat(null === (s = e.WebsiteBlock) || void 0 === s ? void 0 : s._id, "-").concat(t));
                      case "location":
                        var f;
                        return (0,
                        i.jsx)(y, { id: "location-".concat(t), block: e, website: a }, "website-block-".concat(null === (f = e.WebsiteBlock) || void 0 === f ? void 0 : f._id, "-").concat(t));
                      case "quote":
                        var j;
                        return (0,
                        i.jsx)(v, { id: "quote-".concat(t), block: e, website: a }, "website-block-".concat(null === (j = e.WebsiteBlock) || void 0 === j ? void 0 : j._id, "-").concat(t));
                      case "text":
                        var O;
                        return (0,
                        i.jsx)(w, { id: "text-".concat(t), block: e, website: a }, "website-block-".concat(null === (O = e.WebsiteBlock) || void 0 === O ? void 0 : O._id, "-").concat(t));
                      case "video":
                        var E;
                        return (0,
                        i.jsx)(m, { id: "video-".concat(t), block: e, website: a }, "website-block-".concat(null === (E = e.WebsiteBlock) || void 0 === E ? void 0 : E._id, "-").concat(t));
                      case "embed":
                        var P;
                        return (0,
                        i.jsx)(C, { id: "embed-".concat(t), block: e, website: a }, "website-block-".concat(null === (P = e.WebsiteBlock) || void 0 === P ? void 0 : P._id, "-").concat(t));
                      case "image":
                        var A;
                        return (0,
                        i.jsx)(_, { id: "image-".concat(t), block: e, website: a }, "website-block-".concat(null === (A = e.WebsiteBlock) || void 0 === A ? void 0 : A._id, "-").concat(t));
                      case "calendly-scheduling":
                        var W;
                        return (0,
                        i.jsx)(x, { id: "calendly-".concat(t), block: e, website: a }, "website-block-".concat(null === (W = e.WebsiteBlock) || void 0 === W ? void 0 : W._id, "-").concat(t));
                      case "instagram":
                        var G;
                        return (0,
                        i.jsx)(S, { id: "instagram-".concat(t), block: e }, "website-block-".concat(null === (G = e.WebsiteBlock) || void 0 === G ? void 0 : G._id, "-").concat(t));
                    }
                  })(e, t);
                })
            : (0, i.jsx)(f, { website: a });
